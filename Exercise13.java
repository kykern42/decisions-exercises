...
public class Exercise13 {
    ...
    public static void main(String[] args) {
        ...
        if  (haystack.contains(needle)) {
            System.out.printf("%s contains %s%n", haystack, needle);
            System.out.println("It's at index: " + haystack.indexOf(needle));
        } else {
            System.out.printf("%s does NOT contain %s%n", haystack, needle);
        }
    }
}
